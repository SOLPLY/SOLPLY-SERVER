...
public class PersonaTagMappingStrategy {
    ...
    private final Map<UserPersona, List<String>> personaTagMap;

    public PersonaTagMappingStrategy() {
        this.personaTagMap = initializePersonaTagMapping();
    }

    private Map<UserPersona, List<String>> initializePersonaTagMapping() {
        Map<UserPersona, List<String>> mapping = new EnumMap<>(UserPersona.class);
...
//        ));
    ...
    public List<String> getTagsByPersona(UserPersona persona) {
