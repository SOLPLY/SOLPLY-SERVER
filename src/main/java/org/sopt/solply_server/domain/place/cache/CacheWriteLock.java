...
/**
 * 목록 캐시의 <b>쓰기를 한 줄로 세우는</b> 락. 여기 들어오는 것은 셋이다 — 전량 재빌드
 * ({@link SnapshotLoader#rebuild()}), 어드민이 손댄 장소들의 부분 패치
 * ({@link SnapshotLoader#patch}), 그리고 표시값 패치({@link SnapshotRefresher}의 홀더 {@code put}).
 *
 ...
 * ({@code SnapshotLoader#rebuild}·{@code #patch}).
 *
