...
ALTER TABLE place_tag
    ...
    ADD CONSTRAINT fk_place_tag_place
...
ALTER TABLE place_social_links
    ...
    ADD CONSTRAINT fk_place_social_links_place
        FOREIGN KEY (place_id) REFERENCES places (id) ON DELETE CASCADE;
