...
public class CourseBookmarkFlushScheduler implements RedisFlushScheduler {
    ...
    private final CourseBookmarkRedisDataProcessor courseBookmarkProcessor;
    ...
    private int flushRedisData() {
        log.info("Redis 코스 북마크 데이터 플러시 시작");

        int processedCount = courseBookmarkProcessor.flushAllPendingCourseBookmarks();

        log.info("Redis 코스 북마크 데이터 플러시 완료 - 처리: {}건", processedCount);
