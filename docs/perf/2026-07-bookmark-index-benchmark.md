...
| 부하 | Artillery 워밍업 10초@20 + 유지 165초@50 req/s (회당 175초·8,450 요청), 사용자 1,000명 토큰 랜덤 배분. bench 프로파일 의도는 55초였으나 `environments`의 phase 원소 단위 병합으로 기본 프로파일 3번째 phase(120초@50)가 잔존 — 전 상태 동일 조건이라 상대 비교 유효 (#381에서 발견·정정) |
